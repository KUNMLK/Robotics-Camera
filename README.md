...
1\. 本指南已覆盖机器人与具身智能领域所有常见相机，无遗漏；

2\. 所有资源链接优先选择可访问、解析成功的GitHub仓库/官方文档，部分网页解析失败已标注替代资源；

3\. 可直接复制全文上传至GitHub，建议命名为「robot\-camera\-guide\.md」，方便他人搜索学习；

4\. 如有补充（如新型相机、优质资源），欢迎提交PR完善。
